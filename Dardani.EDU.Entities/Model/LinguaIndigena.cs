...
namespace Dardani.EDU.Entities.Model
{
    public class LinguaIndigena
    {
        ...
        [Display(Name = "Código")]
        [Required(ErrorMessage = "O campo Código deve ser preenchido.")]
        public virtual int Codigo { get; set; } 

        [Display(Name = "Língua Indígena")]
        [Required(ErrorMessage = "O campo Língua Indígena deve ser preenchido.")]
        [StringLength(1, MinimumLength = 1)]
        public virtual string FlagIndigena { get; set; } 
