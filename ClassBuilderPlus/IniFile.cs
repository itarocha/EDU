...
namespace ClassBuilderPlus
{
    ...
    public class IniFile
    {
        ...
        public string[] ReadSections()
        {
            ...
            int i = GetPrivateProfileString(null, null, "", value, 65535, this.path);
            return SplitNullTerminatedStrings(value);
        }

        private static string[] SplitNullTerminatedStrings(StringBuilder value)
        {
            string[] raw = value.ToString().Split('\0');
